...
public class AddPreferences {
	...
	public static void main(String[] args) throws Exception {
		String url = "file:////var/www/workspace/Prototipo/src/ColorBlindOntology.owl";
		
		String classOWL = "UserPreferences";   		
		String individualOWL = args[0];
		String cor = args[1];//"huang2009";
		...
		OWLNamedIndividual color = factory.getOWLNamedIndividual(":"+cor, pm);
		OWLNamedIndividual user = factory.getOWLNamedIndividual(":"+individualOWL, pm);
		OWLObjectProperty isSettedByUserPrefences = factory.getOWLObjectProperty(":isSettedByUserPrefences",pm);
		OWLObjectPropertyAssertionAxiom propertyAssertion = factory.getOWLObjectPropertyAssertionAxiom(isSettedByUserPrefences, user, color);
