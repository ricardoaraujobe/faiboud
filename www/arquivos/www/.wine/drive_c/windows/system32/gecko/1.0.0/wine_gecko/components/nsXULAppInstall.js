...
//@line 41 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
...
const AppInstall = {
  ...
  installApplication : function ai_IA(aAppFile, aDirectory, aLeafName) {
    ...
    if (aDirectory == null) {
//@line 235 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
      aDirectory = getDirectoryKey("ProgF");
      if (vendor)
        aDirectory.append(vendor);
//@line 251 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
    else {
    ...
    if (aLeafName == "") {
//@line 265 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
      aLeafName = appName;
//@line 270 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
    }
...
//@line 341 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
...
//@line 348 "/usr/local/src/wine-mozilla/xulrunner/setup/nsXULAppInstall.js"
  }
};
