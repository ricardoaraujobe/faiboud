...
if (in_array($this->session->userdata('idPatologia'), $deut)) {
    $imagem = 'assets/imagens/grafico/grafico_deut.bmp';
    
}
 
elseif (in_array($this->session->userdata('idPatologia'), $prot)) {
    $imagem = 'assets//imagens/grafico/grafico_prot.bmp';
} else {
    $imagem = "";
}
?>
...
<div class="figura">
    <p><img src="<?= base_url($imagem) ?>" width="550" height="320" alt="grafico"></p>
